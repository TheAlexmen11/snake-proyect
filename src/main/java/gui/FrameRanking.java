...
public class FrameRanking extends javax.swing.JFrame {
    ...
    public FrameRanking() throws SQLException {
        initComponents();

        tableModel = new DefaultTableModel(new String[]{"puesto","nombre", "puntaje"}, 0);

        // Asignar el modelo a la tabla
        tableRanking.setModel(tableModel);

        // Cargar los datos en la tabla
        partida.cargarDatosTabla(tableModel);
    }
